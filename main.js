...
const TANGLE_DRAG_SPEED = 20; // pixels per substep the drag target moves during tangle

// ── Debug ─────────────────────────────────────────────────────────────────────
const DEBUG = false; // show HUD and red overlap markers

// ── Drag ──────────────────────────────────────────────────────────────────────
const DRAG_MAX_SPEED = 5; // max px the drag target moves toward the cursor per substep
...
function nearestPoint(x, y) {
  let best = null,
    bestD = GRAB_RADIUS / camScale; // threshold in world space
...
window.addEventListener("blur", () => {
  dragged = null;
  dragButton = null;
  panning = false; // always reset on focus loss
});
